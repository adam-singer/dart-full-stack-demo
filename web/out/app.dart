...
List<String> __$catNames = toObservable([]);
List<String> get catNames {
  if (__observe.observeReads) {
    __observe.notifyRead(__changes, __observe.ChangeRecord.FIELD, 'catNames');
  }
  return __$catNames;
}
set catNames(List<String> value) {
  if (__observe.hasObservers(__changes)) {
    __observe.notifyChange(__changes, __observe.ChangeRecord.FIELD, 'catNames',
        __$catNames, value);
  }
  __$catNames = value;
}
...
void init_autogenerated() {
  ...
  __e2 = __root.nodes[1];
  __t.loopIterateAttr(__e2, () => catNames, ($list, $index, __t) {
    var name = $list[$index];
    var __e1;
