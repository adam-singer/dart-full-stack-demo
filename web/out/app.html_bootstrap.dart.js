...
submitCat: function() {
  var $name = $.interceptedTypeCast(document.querySelector("#cat-name"), "$isInputElement").value;
  $.HttpRequest_request("/cats", "POST", null, null, null, null, "name=" + $.S($name), null).then$1(new $.submitCat_closure($name));
},
