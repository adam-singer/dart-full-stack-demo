...
submitCat_closure: {"": "Closure;name_0",
  call$1: function(req) {
    return $.add$1$ax($.get$catNames(), this.name_0);
  },
  $isFunction: true
},
...
submitCat: function() {
  ...
  $.HttpRequest_request("/cats", "POST", "application/json", null, null, null, output._contents, null).then$1(new $.submitCat_closure($name));
},
...
init_autogenerated: function() {
  ...
  if (1 >= t1.length)
    throw $.ioore(1);
  __t.children.push(new $.LoopTemplate(new $.init_autogenerated_closure(__html0), new $.init_autogenerated_closure0(), null, $.$index$asx($.get$nodes$x(t1[1]), 1), [], []));
  __root.get$nodes;
  t1 = new $._ChildNodeListLazy(__root)._this.childNodes;
  if (3 >= t1.length)
    throw $.ioore(3);
...
_ChildNodeListLazy: {"": "ListBase;_this",
  ...
  addAll$1$bailout1: function(state0, iterable, t1, len) {
    switch (state0) {
      case 0:
        var t2;
        for (t1 = $.JSArray_methods.get$iterator(iterable), t2 = this._this; t1.moveNext$0();)
...
Isolate.$lazy($, "catNames", "catNames", "get$catNames", function() {
  return $.toObservable([]);
});
